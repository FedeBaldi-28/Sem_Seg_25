...
#################### LOSS & OPTIMIZER ####################
criterion = HybridLoss(alpha=0.3, class_weights=weights_tensor)
...
if __name__ == '__main__':
    ...
    print(f"Training completed: final model saved as final_model_epoch_5_combo_03_focal_07_dice{EPOCHS}.pth")
